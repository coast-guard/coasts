...
const DOC_TITLE_KEYS: Record<string, string> = {
  ...
  'concepts_and_terminology/RUN.md': 'docs.nav.run',
  'concepts_and_terminology/REMOVE.md': 'docs.nav.remove',
  ...
  'harnesses/CLAUDE_CODE.md': 'docs.nav.harnessClaudeCode',
  ...
  'concepts_and_terminology/REMOTES.md': 'docs.nav.remotes',
  'remote_coasts/README.md': 'docs.nav.remoteCoasts',
  'remote_coasts/ARCHITECTURE.md': 'docs.nav.remoteArchitecture',
  'remote_coasts/SETUP.md': 'docs.nav.remoteSetup',
  'remote_coasts/FILE_SYNC.md': 'docs.nav.remoteFileSync',
  'remote_coasts/BUILDS.md': 'docs.nav.remoteBuilds',
  'remote_coasts/CLI.md': 'docs.nav.remoteCli',
