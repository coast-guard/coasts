...
## Совместное использование инфраструктуры между проектами

Если у вас есть несколько проектов, каждому из которых нужна одна и та же база данных или кэш, вы можете один раз объявить эти сервисы в singleton DinD, называемом [Shared Service Group](shared_service_groups/README.md), и направить на него Coastfile каждого проекта. Это позволяет избежать конфликтов host-port между проектами и даёт нескольким проектам возможность совместно использовать данные.
